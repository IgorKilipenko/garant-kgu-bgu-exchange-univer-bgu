...
Функция ЗаполнитьДанныеИзУниверситет(Объект, Знач ДанныеЗагрузки, Знач ИдентификаторХранилища = Неопределено) Экспорт
    ...
    Для Каждого СтрокаДанныхПриказов Из ДанныеЗагрузки.Приказы Цикл
        ...
        ГП_ОбменУниверситетБГУОбработкаДанныхУниверситет.ЗаполнитьТаблицыИндексовСвязейПриказа(
...
Функция ПолучитьГруппировкиСтудентовПриказаСырыхДанныхУниверситет(Знач ДанныеСтудентовПриказа)
    // Для Каждого Элемент Из ДанныеСтудентовПриказа Цикл
    //     Элемент.
    //     КонецЦикла;
КонецФункции

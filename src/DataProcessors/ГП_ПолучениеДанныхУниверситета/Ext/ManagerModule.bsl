...
Функция СопоставитьФакультетыПолученныеИзУниверситет(ТаблицаФакультетов) Экспорт
    ...
    Для Каждого СтрокаТаблицы Из ТаблицаФакультетов Цикл
        ...
        СтруктураДанныхУниверситет.Наименование =
            ГП_ОбменУниверситетБГУПовтИсп.ПолучитьСоответствиеНаименованиеФакультетаБГУ(СтруктураДанныхУниверситет.Наименование);

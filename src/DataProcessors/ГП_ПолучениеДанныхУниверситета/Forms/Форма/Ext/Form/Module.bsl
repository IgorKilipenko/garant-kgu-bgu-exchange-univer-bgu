...
Функция ПолучитьСырыеДанныеУниверситетНаСервере()
    ...
    СервисОбмена = СервисыИнтеграции.ГП_СервисИнтеграцииБГУУниверситет;
    СервисаОбменаАктивен = СервисОбмена.ПолучитьАктивность();
    Если СервисаОбменаАктивен = Ложь Тогда
        РезультатФункции.Успех = Ложь;
        ОбщегоНазначения.СообщитьПользователю("Сервис обмена не активен.");
...
Процедура ВыполнениеОбработкиСервисовИнтеграцииНаСервере()
    ГП_СервисыИнтеграции.ВыполнениеОбработкиСервисовИнтеграции();
КонецПроцедуры

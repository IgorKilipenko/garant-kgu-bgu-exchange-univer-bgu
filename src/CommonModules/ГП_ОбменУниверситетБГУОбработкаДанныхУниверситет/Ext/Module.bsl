...
Функция ЗаписатьСоответствияИдентификаторовОбмена(
        ...
        Знач ИдентификаторТранзакцииСоздания, Знач ДатаСоздания = Неопределено, ВидОбъектаОбменаДополнительный = Неопределено) Экспорт
...
Функция ПолучитьПоляДополнительныхСведенийСтрокиДоговораОбразования()
    РезультатФункции = Новый Структура;

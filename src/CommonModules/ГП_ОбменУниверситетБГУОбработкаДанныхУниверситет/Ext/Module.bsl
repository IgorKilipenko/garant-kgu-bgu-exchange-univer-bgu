...
Функция НайтиДоговорОказанияОбразовательныхУслугПоДаннымУниверситет(Знач СтруктураДанныхСтудента, Знач СтруктураДанныхПриказаУниверситет)
    ВидОбъектаОбмена = ПланыВидовХарактеристик.ГП_ТипыОбъектовОбменаУниверситетБГУ.Факультет;
    ТаблицаИдентификаторов = ПолучитьАктуальныеДанныеИдентификаторовДляВидаОбъектаОбмена(ВидОбъектаОбмена,
            Новый Структура("ИдентификаторВнешний", СтруктураДанныхПриказаУниверситет.Идентификатор));

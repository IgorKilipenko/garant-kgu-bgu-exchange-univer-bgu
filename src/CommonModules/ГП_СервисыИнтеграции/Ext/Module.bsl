...
Функция НовыйСообщениеСервисаИнтеграции(Знач СтруктураСообщения, Знач СервисОбмена) Экспорт
    ...
    Если СтруктураСообщения.Свойство("Параметры") Тогда
        Для Каждого ПараметрКЗ Из СтруктураСообщения.Параметры Цикл
    ...
    Если СтруктураСообщения.Свойство("СтруктураТела") Тогда
        ТелоJSON = ЗначениеJSON(СтруктураТела);
...
Функция ПреобразовательЗначенийJSONТелаСообщений(Знач Свойство, Знач Значение, Знач ДополнительныеПараметры, Отказ) Экспорт
    Если ТипЗнч(Значение) = Тип("Дата") Тогда
        Возврат ПолучитьСтрокуДатыJSON(Значение);
